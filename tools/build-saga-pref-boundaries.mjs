...
async function main() {
  ...
  if (!inputPath || !outputPath) {
    throw new Error("Usage: node tools/build-saga-pref-boundaries.mjs <input.geojson> <output.geojson>");
  }
  ...
  if (jsOutputPath !== outputPath) {
    await fs.writeFile(jsOutputPath, `window.SAGA_PREF_BOUNDARIES = ${serialized};\n`);
  }
