...
async function main() {
  ...
  if (!inputPath || !outputPath) {
    throw new Error("Usage: node tools/build-saitama-seibu-boundaries.mjs <input.geojson> <output.geojson>");
  }
  ...
  if (jsOutputPath !== outputPath) {
    await fs.writeFile(jsOutputPath, `window.SAITAMA_SEIBU_BOUNDARIES = ${serialized};\n`);
  }
