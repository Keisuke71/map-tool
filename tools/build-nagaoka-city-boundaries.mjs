...
async function main() {
  ...
  if (!inputPath || !outputPath) {
    throw new Error("Usage: node tools/build-nagaoka-city-boundaries.mjs <input.geojson> <output.geojson>");
  }
  ...
  if (jsOutputPath !== outputPath) {
    await fs.writeFile(jsOutputPath, `window.NAGAOKA_CITY_BOUNDARIES = ${serialized};\n`);
  }
